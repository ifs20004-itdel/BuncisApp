...
class CalculatorAdapter(private val data: List<SoundingItems>) :
    ...
    override fun onCreateViewHolder(
        ...
        val binding =
            SoundingItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    class ViewHolder(private val binding: SoundingItemBinding) :
